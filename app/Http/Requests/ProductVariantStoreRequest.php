...
#[OA\Schema(
    ...
    title: "ProductVariantRequest",
    description: "Product variant creation request",
    type: "object",
    required: ["product_id", "title"],
    properties: [
        new OA\Property(property: "product_id", type: "integer", format: "int64", example: 1, description: "Product ID"),
        ...
        new OA\Property(property: "inventory_quantity", type: "integer", example: 25, description: "Initial inventory quantity"),
...
class ProductVariantStoreRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'title.required' => 'Variant title is required.',
